...
export class UpdateCiltMstrDTO {
  @ApiProperty({ description: 'CILT ID' })
  @IsNotEmpty()
  @IsNumber()
  id: number;
  ...
  @ApiProperty({ required: false, description: 'CILT name', maxLength: 45 })
  @IsOptional()
  @IsString()
  @Length(1, 45)
  ciltName?: string;

  @ApiProperty({ required: false, description: 'CILT description', maxLength: 255 })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  ...
  @ApiProperty({ required: false, description: 'Creator name', maxLength: 100 })
  @IsOptional()
  @IsString()
  @Length(1, 100)
  creatorName?: string;
  ...
  @ApiProperty({ required: false, description: 'Reviewer name', maxLength: 100 })
  @IsOptional()
  @IsString()
  @Length(1, 100)
  reviewerName?: string;
  ...
  @ApiProperty({ required: false, description: 'Approver name', maxLength: 100 })
  @IsOptional()
  @IsString()
  @Length(1, 100)
  approvedByName?: string;

  @ApiProperty({ required: false, description: 'Standard execution time in seconds' })
  @IsOptional()
  @IsNumber()
  standardTime?: number;

  @ApiProperty({ required: false, description: 'Learning time', maxLength: 25 })
  @IsOptional()
  @IsString()
  @Length(1, 25)
  learnigTime?: string;

  @ApiProperty({ required: false, description: 'Layout image URL', maxLength: 500 })
  @IsOptional()
  @IsString()
  @Length(1, 500)
  urlImgLayout?: string;
  ...
  @ApiProperty({ required: false, description: 'CILT status', default: 'A' })
  @IsOptional()
  @IsString()
  @Length(1, 1)
  status?: string;
