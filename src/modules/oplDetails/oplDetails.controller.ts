...
export class OplDetailsController {
  ...
  @ApiResponse({ status: 200, description: 'List of OPL details', type: [ResponseOplDetailsDTO] })
  async findAll() {
  ...
  @ApiResponse({ status: 200, description: 'OPL detail found', type: ResponseOplDetailsDTO })
  ...
  @ApiResponse({ status: 201, description: 'OPL detail created successfully', type: ResponseOplDetailsDTO })
  ...
  @ApiResponse({ status: 200, description: 'OPL detail updated successfully', type: ResponseOplDetailsDTO })
  @ApiResponse({ status: 404, description: 'OPL detail not found' })
